...
import { Bell, Clock, Target, CheckSquare, Trash2, ArrowRight, CheckCircle2 } from 'lucide-react';
...
export function NotificationDropdown({
  ...
  return (
    <motion.div
      ...
      className="absolute right-12 sm:right-16 top-[calc(100%+12px)] w-[21rem] rounded-2xl z-50 p-[1.5px] bg-gradient-to-br from-fuchsia-500/60 via-purple-500/40 to-sky-400/60 shadow-[0_20px_50px_rgba(99,102,241,0.25)] dark:shadow-[0_25px_60px_rgba(0,0,0,0.85)]"
      ...
      <div className="relative w-full h-full rounded-[14px] overflow-hidden p-4 bg-gradient-to-b from-slate-50 via-indigo-50/90 to-purple-50 text-slate-900 dark:bg-gradient-to-b dark:from-[#160f2e] dark:via-[#110a24] dark:to-[#0b0718] dark:text-white backdrop-blur-xl border border-purple-200/80 dark:border-purple-500/25">
          ...
          <div className="space-y-2 max-h-64 overflow-y-auto pr-1">
            {upcoming.map((r: any) => {
              ...
              return (
                <div
                  key={r.id}
                  className="flex items-center justify-between gap-2 p-2.5 rounded-xl border border-purple-200/60 dark:border-white/5 bg-white/70 dark:bg-white/[0.03] hover:border-purple-400 transition"
                >
        ...
        <div className="mt-3 pt-3 border-t border-purple-200/60 dark:border-white/10">
          <button
            ...
            className="w-full py-2 rounded-xl bg-purple-600/15 hover:bg-purple-600/25 text-purple-700 dark:text-fuchsia-300 text-xs font-bold transition flex items-center justify-center gap-1.5 border border-purple-500/20"
          >
